          ...
          <div className="shrink-0 space-y-4 px-6 pb-4 pt-5">
            <form onSubmit={handleScan} className="relative">
              ...
              <input
                ...
                className="h-14 w-full rounded-xl border-2 border-brand-400 bg-white pl-12 pr-44 text-base text-slate-900 shadow-[0_0_0_4px_rgba(59,91,255,0.10)] placeholder:text-slate-400 focus:border-brand-500 focus:shadow-[0_0_0_5px_rgba(59,91,255,0.16)] focus:outline-none"
              />
              ...
              <div className="absolute right-3 top-1/2 flex -translate-y-1/2 items-center gap-1.5">
                ...
                <kbd className="hidden md:inline-block rounded-md border border-slate-200 bg-slate-50 px-2 py-1 font-mono text-[10px] font-medium text-slate-500">
                  F3
                </kbd>
              </div>
            </form>
